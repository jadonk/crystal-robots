...
Spec suite: 101 examples green with `-Dwasmer`; `crystal run ci.cr -- --with-wasmer` green end to end; `crystal run ci.cr -- --with-wasm32` green end to end (149 examples, 0 failures, 0 errors, 10 pending as of the Phase 6 unit — the wasmer-gated cases; `crystal run ci.cr` plain is 149 examples, 0 failures, 17 pending).
